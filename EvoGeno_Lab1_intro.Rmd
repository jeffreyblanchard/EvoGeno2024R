...
If you are a graduate student in 678 please set up an account (you will need your PIs approval) on Unity <https://unity.rc.umass.edu/>. You will be using R and RStudio from the Unity HPC. You are also welcome to use R and RStudio it from your own computer.
