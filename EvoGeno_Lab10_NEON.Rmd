...
Using the table from Labs 8 and 9
...
* A table from IMG with the metagenome information including Ecosystem subtype, latitude, longitude, Genome Size, Gene Count. Just display the table in your Lab 10 report. You will need to use `read_tsv` because although it says it is a csv file it is actually a tsv file.  We will work more with this table next week.
